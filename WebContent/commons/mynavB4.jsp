...
<nav class="navbar navbar-expand-sm bg-light">
	...
	<ul class="navbar-nav">
		...
		<li class="dropdown nav-item"><a href="" class="dropdown-toggle nav-link"
			...
			<div class="dropdown-menu">
				<a href="upload_resource" class="dropdown-item">上传资源</a> <a href="DownloadResource"
					class="dropdown-item">下载资源</a>
			</div></li>
		<li class="nav-item"><a href="Website" class="nav-link">常用网址</a></li>
		<c:if test="${empty user}">
			<li class="nav-item"><a href="signup.html" class="nav-link">注册</a></li>
		...
		<c:if test="${not empty user}">
			<li class="dropdown nav-item"><a href="" class="dropdown-toggle nav-link"
				...
				<div class="dropdown-menu">
					<a href="user_center" class="dropdown-item">个人中心</a>
