...
<nav class="navbar navbar-default" role="navigation">
	<div class="navber-header">
		...
		<a href="main" class="navbar-brand text-center">云大助手</a>
	</div>
	...
	<div class="collapse navbar-collapse" id="my-collapse">
		<ul class="nav navbar-nav">
			...
			<li class="dropdown"><a href="" class="dropdown-toggle"
				data-toggle="dropdown">失物招领 <b class="caret"></b></a>
			...
			<!-- 查询 -->
			<li class="dropdown"><a href="#" class="dropdown-toggle"
				data-toggle="dropdown">余额查询<b class="caret"></b></a>
				<ul class="dropdown-menu">
					<li><a href="#d2">水电查询</a></li>
					<li><a href="#d3" id="card-balance"
						onclick="cardBalance('${user.cardBalance}')">一卡通余额 </a></li>
				</ul></li>

			<li class="dropdown"><a href="#" class="dropdown-toogle"
				data-toggle="dropdown">资源共享 <b class="caret"></b></a>
				<ul class="dropdown-menu">
		...
		<c:if test="${empty user}">
			<ul class="nav navbar-nav navbar-right margin-right-5px">
				...
				<li><a onclick="show_login()"><span
						class="glyphicon glyphicon-log-in"></span> 登录</a></li>
			</ul>
		</c:if>
		<c:if test="${not empty user}">
			<ul class="nav navbar-nav navbar-right margin-right-5px">
				<li class="dropdown"><a class="dropdown-toggle nav-background"
					...
					<ul class="dropdown-menu">
						...
						<c:if test="${user.hasBasePermission()}">
							<li><a id="admin-operation-center"
								href="AdministratorCenter">网站后台</a></li>
						</c:if>
						<li class="divider"></li>
