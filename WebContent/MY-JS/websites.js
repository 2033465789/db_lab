...
function loadWebsiteInfo(aim_url, img_url, web_name, web_desc)
{
    ...
    var imginfo = $("<div col-md-12 col-sm-12'><img src='" + img_url + "' class='img-thumbnail image-rounded img-responsive' /></div>");
    var name = $("<div class='col-md-12 col-sm-12'><span class='text-center'><h2>" + web_name + "</h2></span></div>");
    var desc = $("<div class='webDesc col-md-12 col-sm-12'><span class='margin-top-bottom-10px'>" + web_desc + "</span></div>");
...
function addWebsite()
{
    ...
    if (name == "" || desc == "" || url == "" || formData.get('fileName') == null)
    {
        $.growl.notice({
            title : "",
            message : "请将信息填写完整"
