	...
	<c:if test="${user.userPermission > 1}">
		...
		<div class="container">
			...
			<div class="row">
				...
				<div id="shared-op" class="col-md-12 admin-module">
					<ul class="nav nav-tabs">
						<li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#home">分享的资源管理</a></li>
						<li class="nav-item"><a class="nav-link" data-toggle="tab" href="#menu1">所有评论管理</a></li>
						<li class="nav-item"><a class="nav-link" data-toggle="tab" href="#menu2">失物招领管理</a></li>
					</ul>
					<!-- Tab panes -->
