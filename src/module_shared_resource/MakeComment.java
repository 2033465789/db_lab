...
public class MakeComment extends HttpServlet
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		try
		{
			...
			StringUtil stringUtil = StringUtil.getStringTool(getServletContext());

			Comment comment = new Comment(fid, user.getUserId(), fid, content,
					stringUtil.getCurrentTime("yyyy-MM-dd HH:mm:ss"), null);
