...
public class CacheUtil {
	...
	// 缓存大小
	private final int GOODSCACHE_MAX_SIZE = 1;
	private final int SHAREDCACHE_MAX_SIZE = 1;
	private final int COMMENTCACHE_MAX_SIZE = 1;

	/*
	 * private int lastSharedCount; private int lastLostCount; private int lastCommentCount;
	 */

	// 缓存列表
	private ArrayList<Good> goodsCache;
	private ArrayList<SharedResource> sharedCache;
	private ArrayList<CommentFile> commentCache;
	...
	private CacheUtil() {
		...
		commentCache = new ArrayList<CommentFile>(COMMENTCACHE_MAX_SIZE + 3);
	}
	...
	public ArrayList<CommentFile> getCommentsCache() {
		return commentCache;
	}
	...
	public boolean addItemToSharedCache(SharedResource e)
	...
	public boolean addItemToCommentCache(CommentFile e)
			throws MyException, DBConnctionException {
		// 加锁
	...
	public boolean addItemToGoodsCache(Good e)
			throws MyException, DBConnctionException {
		// 加锁
	...
	public static int getNewItemId(Collection<?> coll, String tableName)
	...
	private void flushCommentCache() throws DBConnctionException {
		ArrayList<CommentFile> tmp = commentCache;
		commentCache = new ArrayList<CommentFile>(COMMENTCACHE_MAX_SIZE + 3);
	...
	public synchronized boolean FlushAllCache()
			throws MyException, DBConnctionException {
		// 加锁
		synchronized (sharedCache) {
			flushdsharedCache();
		...
		return sharedCache.size() == 0 && goodsCache.size() == 0
				&& commentCache.size() == 0;
	}
}
